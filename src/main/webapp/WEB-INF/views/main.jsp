...
<div class="topall">
    <div class="top">
        <p style="text-align:center">
            <img src="${basePath}/resources/img/top.jpg">
        </p>
    </div>
</div>
<div class="nav" style="background:#fc410a">
    <div class="memu">
        <ul>
...
<div class="bodymain">
    ...
    <div class="maincont right">
        <div class="head">
            <p>联系我们</p>
            <span>网站当前位置：<a href="http://china-gangtai.com/index.asp">网站首页</a> &gt; 联系我们</span>
        </div>
        <div class="cont">
            <div class="lxcom">
                <span style="color:#333; font-size:20px; font-family:微软雅黑;">新密市金诚耐材有限公司</span><br>
                <table cellspacing="0" cellpadding="0">
                    <tbody>
                    <tr>
                        <td height="35" align="left">公司地址：河南省新密市超化镇西工业园区</td>
                    </tr>
                    <tr>
                        <td height="35" align="left">联系人：李佩丽</td>
                    </tr>
                    <tr>
                        <td height="35" align="left">手机：0086-013921839380</td>
                    </tr>
                    <tr>
                        <td height="35" align="left">电话：0086-0515-85540102</td>
                    </tr>
                    <tr>
                        <td height="35" align="left">传真：0086-0515-85540127</td>
                    </tr>
                    <tr>
                        <td height="35" align="left">邮箱：gt@china-gangtai.com　</td>
                    </tr>
                    <tr>
                        <td height="35" align="left">网址：www.china-gangtai.com</td>
                    </tr>
                    </tbody>
                </table>
                <br>
